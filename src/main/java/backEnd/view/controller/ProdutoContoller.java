package backEnd.view.controller;
...
import backEnd.view.model.ProdutoRequest;
import backEnd.view.model.ProdutoResponse;
...
public class ProdutoContoller {
    ...
    public ResponseEntity<List<ProdutoResponse>> obterTodos(){
    	...
    	List<ProdutoResponse> resposta = produtos.stream()
    			.map(ptodutoDto -> mapper.map(ptodutoDto, ProdutoResponse.class))
